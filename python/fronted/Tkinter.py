...
class AppWindow:
    ...
    def build_interface_selection(self):
        ...
        if num_files >= 1:
            ...
            self.interface_widgets.append(button_interface01)
            ...
            self.interface_widgets.append(button_interface02)
        ...
        if num_files == 1 :
            ...
            self.interface_widgets.append(button_interface03)
    ...
    def open_interface(self, interface_num):
        ...
        self.interface_widgets.append(button_return)
    ...
    def clear_interface_widgets(self):
